'''
Executa regras relacionadas à entidade FPSM referentes ao encerramento.
'''
import os.path
...
padrepo = PadRepo(path=os.path.join(r'C:\Users\Everton\Desktop\Prefeitura\PAD', f'{ano}-{mes}', 'parquet'), entities=['fpsm'])
...
reporters = [ScreenReporter(), ExcelReporter(r'report-encerramento-fpsm.xlsx')]
