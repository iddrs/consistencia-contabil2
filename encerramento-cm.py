'''
Executa regras relacionadas à entidade Câmara referentes ao encerramento.
'''
import os.path

from contest.rules.encerramento import *
...
padrepo = PadRepo(path=os.path.join(r'C:\Users\Everton\OneDrive - independencia.rs.gov.br\Prefeitura\PAD', f'{ano}-{mes}', 'parquet'), entities=['cm'])
...
reporters = [ScreenReporter(), ExcelReporter(r'report-encerramento-cm.xlsx')]
...
check_rules = (
    ...
    disponibilidades,
    resultado_periodo_consolidacao,
    resultado_periodo_intra_ofss,
    resultado_periodo_inter_ofss_uniao,
    resultado_periodo_inter_ofss_estado,
    resultado_periodo_inter_ofss_municipio,
    ddr_disponivel,
